									...
									<Button
										...
										onClick={async () => {
											await reload({
												...
												.catch((error) => {
													toast.error(
														error?.message || "Error reloading application",
													);
												});
										}}
									>
									...
									<Button
										...
										onClick={async () => {
											await redeploy({
												...
												.catch((error) => {
													toast.error(
														error?.message || "Error rebuilding application",
													);
												});
										}}
									>
									...
									<Button
										...
										onClick={async () => {
											await start({
												...
												.catch((error) => {
													toast.error(
														error?.message || "Error starting application",
													);
												});
										}}
									>
							...
							<DialogAction
								...
								onClick={async () => {
									await stop({
										...
										.catch((error) => {
											toast.error(
												error?.message || "Error stopping application",
											);
										});
								}}
							>
