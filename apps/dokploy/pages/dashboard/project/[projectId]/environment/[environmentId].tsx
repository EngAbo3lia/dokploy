												...
												<div className="flex flex-wrap items-center gap-4">
													<div className="flex items-center gap-2">
														...
														<span className="text-sm">
															{selectedServices.length} of{" "}
															{filteredServices.length} selected
														</span>
													</div>
																			...
																			<div className="space-y-3">
																				...
																				{selectedServicesWithRunningStatus.length >
																					...
																					<AlertBlock type="warning">
																						...
																						of the selected services are
																						currently running. Please stop these
																						services first before deleting:{" "}
																...
																<DialogContent>
																	<DialogHeader>
																		...
																		<DialogDescription>
																			...
																			to move {selectedServices.length} services
																		</DialogDescription>
																	</DialogHeader>
																...
																<DialogContent>
																	...
																	<div className="space-y-4">
																		...
																		{(() => {
																			...
																			if (
																				servicesWithVolumeSupport.length === 0
																			)
																				return null;
																					...
																					<div className="flex w-full flex-row items-center justify-between gap-2">
																						<div className="flex flex-col gap-1">
																							...
																							<div className="flex items-center gap-1.5 text-[11px] text-muted-foreground">
																								...
																								{service.type ===
																									"postgres" && (
																									<PostgresqlIcon className="size-3" />
																								)}
																								{service.type === "redis" && (
																									<RedisIcon className="size-3" />
																								)}
																								{service.type === "mariadb" && (
																									<MariadbIcon className="size-3" />
																								)}
																								{service.type === "mongo" && (
																									<MongodbIcon className="size-3" />
																								)}
																								{service.type === "mysql" && (
																									<MysqlIcon className="size-3" />
																								)}
																								{service.type === "libsql" && (
																									<LibsqlIcon className="size-3" />
																								)}
																								{service.type === "compose"
																									? "Docker Compose"
																									: service.type ===
